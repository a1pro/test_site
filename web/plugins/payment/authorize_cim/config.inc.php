...
$notebook_page = 'Authorize.Net CIM';
...
add_config_field('payment.authorize_cim.login', 'API Login',
    'text', "",
    $notebook_page, 
    '');
add_config_field('payment.authorize_cim.tkey', 'Transaction Key',
    'text', 
...
5. Click Submit<br />",
    $notebook_page, 
    '');
add_config_field('payment.authorize_cim.testing', 'Test Mode Enabled',
    'select', "set to No after you complete testing",
    $notebook_page, 
    '','','',
    array('options' => array(0 => 'No', 1 => 'Yes')));

cc_core_add_config_items('authorize_cim', $notebook_page);
?>
