...
//curl_setopt($this->ch, CURLOPT_CAINFO, 'f:\php-4.3.2-win32\extensions\curl-ca-bundle.crt');
	...
	*/
	function send($data, $timeout=0, $response_timeout=30, $cookies=NULL) {
        ...
        */
	    $data = str_replace ("<thirdPartyPaymentRequest>", "<ThirdPartyPaymentRequest xmlns=\"http://api.bidpay.com/ThirdPartyPayment/v1/Messages/ThirdPartyPaymentRequest-1-1\">", $data);
	    $data = str_replace ("</thirdPartyPaymentRequest>", "</ThirdPartyPaymentRequest>", $data);
...
class wsdl extends nusoap_base {
	...
	*/
	...
	{
		//echo "[$operation]";print_r ($this->bindings);print_r ($this->ports);
		if ($bindingType == 'soap') {
			$bindingType = 'http://schemas.xmlsoap.org/wsdl/soap/';
		}
		// loop thru ports
