...
add_config_field('payment.efsnet.store_id', 'EFSNet Store Id',
    'text', "your EFSNet id",
    $notebook_page, 
    '');
add_config_field('payment.efsnet.store_key', 'EFSNet Store Key',
    'text', "your EFSNet store <a href='https://testsecure.todaysebiz.com/ssl/services/welcome/ChangeStoreKey.asp' target=_blank>key</a>",
    $notebook_page, 
    '');
add_config_field('payment.efsnet.testing', 'Test Mode Enabled',
