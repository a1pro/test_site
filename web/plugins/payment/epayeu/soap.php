...
/*
$Id: nusoap.php 1739 2006-06-19 07:02:10Z avp $
...
* @version  $Id: nusoap.php 1739 2006-06-19 07:02:10Z avp $
* @access   public
*/
class nusoap_base {
...
//	global $db;	echo "<pre>$string</pre><br>";	
    }
...
class soapclient_epayeu extends nusoap_base  {
    ...
    * @access   public
    */
    function soapclient_epayeu($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
...
//            $namespace = isset($opData['input']['namespace']) ? $opData['input']['namespace'] : ($namespace != '' ? $namespace : 'http://testuri.org');
            $namespace = ($namespace != '' ? $namespace : 'http://testuri.org');
            $style = $opData['style'];
    ...
    */
    function getProxy(){
        ...
        $r = rand();
        $evalStr = 'class soap_proxy_'.$r.' extends soapclient_epayeu {
                '.$evalStr.'
            }';
