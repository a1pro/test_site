...
class PsiGatePayment {
    ...
    function doPayment() {
        ...
        if ($this->ItemID){
            $xmlRequest .=
            	"<Item>".
            	"   <ItemID>".htmlentities( $this->ItemID )."</ItemID>".
            	"   <ItemDescription>".htmlentities( $this->ItemDescription )."</ItemDescription>".
            	"   <ItemQty>".htmlentities( $this->ItemQty )."</ItemQty>".
            	"   <ItemPrice>".htmlentities( $this->ItemPrice )."</ItemPrice>".
            	"</Item>";
        }
        $xmlRequest .=
        "</Order>";
