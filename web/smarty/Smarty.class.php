...
/* $Id: Smarty.class.php 5204 2010-08-27 07:58:28Z alex $ */
 ...
 * set _SMARTY_DIR to absolute path to Smarty library files.

 * if not defined, include_path will be used. Sets _SMARTY_DIR only if user
...
if (!defined('_SMARTY_DIR')) {

    define('_SMARTY_DIR', dirname(__FILE__) . DIRECTORY_SEPARATOR);
...

{
    ...
    var $compiler_class        =   '_Smarty_Compiler';
 ...
 */
    ...
    $_auto_id = $this->_get_auto_id($cache_id, $compile_id);
        ...
        if (!empty($this->cache_handler_func)) {
            ...
            require_once(_SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.rm_auto.php');
...

    {
        ...
        if ($display && !$this->caching && count($this->_plugins['outputfilter']) == 0) {
            ...
            foreach ((array)$this->_plugins['outputfilter'] as $_output_filter) {
                ...
                // changed by alex@cgi-central.net - add third argument $resource_name
        ...
        if ($resource_name == 'memory:text'){

        	@unlink($_smarty_compile_path);
...

    {
        ...
        require_once(_SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.assemble_plugin_filepath.php');
   ...
   /**
...

    {
        ...
        if (file_exists(_SMARTY_DIR . $this->compiler_file)) {

            require_once(_SMARTY_DIR . $this->compiler_file);
...

    {
        ...
        if (!$_return) {
            ...
            require_once(_SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.is_secure.php');
        ...
        if ($params['resource_type'] == 'file') {
            ...
            if (!preg_match("/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/", $params['resource_name'])) {
                ...
                foreach ($_resource_base_path as $_curr_path) {
                    ...
                    require_once(_SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.get_include_path.php');
            ...
            require_once(_SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_resource_plugin.php');
