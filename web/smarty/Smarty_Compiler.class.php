...
/* $Id: Smarty_Compiler.class.php 1640 2006-06-07 19:29:19Z avp $ */

/**
 * Template compiling class
 * @package Smarty
 */
class _Smarty_Compiler extends _Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        if (count($this->_plugin_info)) {
            ...
            $_plugins_params .= '))';
            $plugins_code = "<?php require_once(_SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');\nsmarty_core_load_plugins($_plugins_params, \$this); ?>\n";
        ...
        if ($this->_init_smarty_vars) {
            $template_header .= "<?php require_once(_SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.assign_smarty_interface.php');\nsmarty_core_assign_smarty_interface(null, \$this); ?>\n";
    ...
    function _compile_insert_tag($tag_args)
    {
        ...
        return "<?php require_once(_SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.run_insert_handler.php');\necho smarty_core_run_insert_handler($_params, \$this); ?>" . $this->_additional_newline;
    }
    ...
    function _compile_include_php_tag($tag_args)
    {
        ...
        return "<?php require_once(_SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.smarty_include_php.php');\nsmarty_core_smarty_include_php($_params, \$this); ?>" . $this->_additional_newline;
    }
