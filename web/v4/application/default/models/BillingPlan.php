...
class BillingPlan extends Am_Record_WithData {
    ...
    public function getProduct()
    {
        ...
        return $this->_product = $this->getDi()->productTable->load($this->product_id, true);
    }
...
class BillingPlanTable extends Am_Table_WithData {
    ...
    {
        $ret = array();
        foreach ($this->selectObjects("SELECT bp.*, p.title as product_title 
                FROM $this->_table bp 
                LEFT JOIN ?_product p USING (product_id)
                ORDER BY product_title") as $p)
        {
