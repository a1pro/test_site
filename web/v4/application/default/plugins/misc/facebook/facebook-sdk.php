...
// commented require_once "base_facebook.php";
...
// uses aMember session storage
class Am_Facebook extends BaseFacebook
{
   ...
   * @see BaseFacebook::__construct in facebook.php
   */
  public function __construct($config, Zend_Session_Namespace $session) {
    parent::__construct($config);
