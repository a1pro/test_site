...
(function( $ ){
    var methods = {
        ...
        addFile: function(info) {
            ...
            $this.data('params').onChange.call($this);
            $this.data('params').onSuccess.call($this, info);
            $this.closest('.reupload-conteiner').find('.upload-name').text(info.name);
            $this.closest('.reupload-conteiner').find('.filesmanager-file').data('info', info);
            $this.reupload('destroyUploader');
            $this.closest('.reupload-conteiner').find('.reupload-conteiner-hide').remove();
        }
        ,
