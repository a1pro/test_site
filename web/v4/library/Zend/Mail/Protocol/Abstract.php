 ...
 * @version    $Id: Abstract.php 23476 2010-12-06 20:10:27Z mjh_ca $
 */
...
/**
 * Added by Alex Scott alex@cgi-central.net
 * I believe using Zend_Validator_Hostname adds unacceptable overhead to this
 * class, so it is disabled in this project.
 */
class Dummy_Zend_Validate {
...
abstract class Zend_Mail_Protocol_Abstract
{
    ...
    {
        $this->_validHost = new Dummy_Zend_Validate();
