...
class SetupController {
    ...
    function check_for_writeable(){
        ...
        if (!is_writeable($d = "$root_dir/data/"))
            $this->addError("Directory '$d' is not writeable. Please <a href='http://manual.amember.com/How_To_Chmod' target=_blank>fix it</a>");
        if (!is_writeable($d = "$root_dir/data/cache"))
            $this->addError("Directory '$d' is not writeable. Please <a href='http://manual.amember.com/How_To_Chmod' target=_blank>fix it</a>");
        if (!is_writeable($d = "$root_dir/data/new-rewrite/"))
            $this->addError("Directory '$d' is not writeable. Please <a href='http://manual.amember.com/How_To_Chmod' target=_blank>fix it</a>");
        return !$this->errors;
    }
...
<p>You can find  the aMember Pro User's Guide <a href='http://manual.amember.com/'>here</a>.
...
<p>Go to the <a href='../admin-setup' target=_blank>Admin Setup/Configuration page</a>
    Enable any additional payment plugins you need and 'Save'. Then confuguration pages for plugins
        ...
        <div class="am-footer">
            <div class="am-footer-content-wrapper am-main">
                <div class="am-footer-content">
                    ...
                    aMember Pro&trade; 4.1.10 by <a href="http://www.amember.com">aMember.com</a>  &copy; 2002&ndash;{$year} CGI-Central.Net
                </div>
            </div>
        </div>
    </body>
